    ...
    <>
      {Array.from({ length: 10 }).map((_, i) => (
        <RigidBody key={i} colliders='cuboid' position={[-5, (i + 1) * 1.01, 0]} type='dynamic' mass={0.5}>
          <Box args={[1, 1, 1]} castShadow receiveShadow getObjectsByProperty={undefined} getVertexPosition={undefined}>
      ...
      <RigidBody colliders='cuboid' position={[0, -8, 0]} type='fixed'>
        <Box args={[40, 1, 40]} castShadow receiveShadow getObjectsByProperty={undefined} getVertexPosition={undefined}>
