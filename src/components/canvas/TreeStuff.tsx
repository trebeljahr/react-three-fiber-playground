...
export const InstancedTreesWithPhysics = () => {
  ...
  const COUNT = 10
  const positions: Vector3Array[] = Array.from({ length: COUNT }, () => [randFloat(-10, 10), 0, randFloat(-10, 10)])
...
export function Trees() {
  const positions = new Array(100).fill(0).map(() => new Vector3(randFloat(-200, 200), 0, randFloat(-200, 200)))
  return (
    <>
